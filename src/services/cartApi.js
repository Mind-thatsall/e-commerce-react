...
export const getCartItems = async () => {
  try {
    ...
    console.error(err);
    if(err.code === "ERR_NETWORK") throw new Error("An error occurred while fetching your cart.");
  }
};
...
export const addCartItem = async (item) => {
  try {
    ...
    console.error(err);
    if(err.code === "ERR_NETWORK" || err.code === "ERR_BAD_REQUEST") throw new Error("An error occurred while trying to add an item to your cart.");
  }
};
