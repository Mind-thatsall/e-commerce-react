...
const Cart = () => {
  return (
    <div className="h-screen px-[4vw] md:px-[6vw] lg:px-[4vw] flex justify-center items-center">
      <div
      ...
      >
        ...
        <span className="w-1 h-full bg-black hidden lg:block"></span>
        <div className="w-full flex flex-col gap-5">
          ...
          <div className="flex justify-between items-center">
            <p>4 ARTICLES</p>
            <button type="" className="px-4 py-2 border-2 border-black">
              CHECKOUT
            </button>
          </div>
        </div>
